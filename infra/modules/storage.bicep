...
resource imageContainer 'Microsoft.Storage/storageAccounts/blobServices/containers@2026-04-01' = {
...
resource requestQueue 'Microsoft.Storage/storageAccounts/queueServices/queues@2026-04-01' = {
  name: requestQueueName
  parent: queueService
}

resource resultQueue 'Microsoft.Storage/storageAccounts/queueServices/queues@2026-04-01' = {
