...
resource imageContainer 'Microsoft.Storage/storageAccounts/blobServices/containers@2025-06-01' = {
...
resource requestQueue 'Microsoft.Storage/storageAccounts/queueServices/queues@2025-06-01' = {
  name: requestQueueName
  parent: queueService
}

resource resultQueue 'Microsoft.Storage/storageAccounts/queueServices/queues@2025-06-01' = {
